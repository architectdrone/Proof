...
import static org.architectdrone.java.with.antlr.unparser.Constants.STATEMENT_EXPRESSION;

public class ForUpdatePattern extends UnparserPattern<JavaNode> {
    @Override
    public List<DisplayElement> unparse(final DisplayElement label, final DisplayElementAccessor<JavaNode> displayElementAccessor) {
        ...
        builder.spaceList(STATEMENT_EXPRESSION);
