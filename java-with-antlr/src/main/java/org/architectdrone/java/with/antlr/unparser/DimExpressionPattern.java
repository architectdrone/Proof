...
public class DimExpressionPattern extends UnparserPattern<JavaNode> {
    @Override
    public List<DisplayElement> unparse(final DisplayElement label, final DisplayElementAccessor<JavaNode> displayElementAccessor) {
        ...
        builder.space();
        DisplayElementAccessor<JavaNode> onlyExpression = displayElementAccessor.withLabels(Constants.EXPRESSIONS);
        builder.displayElements(onlyExpression.getDisplayElements());
